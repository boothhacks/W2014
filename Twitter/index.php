...
$BHList =  $connection->get('lists/list', array('user_id' => $DH[0]->id_str));
$BHID = 0;
...
{
	array_push($followers, $Members->users[$x]->screen_name => count($connection->get('followers/ids', array('screen_name' => $Members->users[$x]->screen_name))->ids));
}
